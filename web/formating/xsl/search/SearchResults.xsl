                                            ...
                                            <xsl:choose>
                                                ...
                                                <xsl:when test="name() = 'ΨηφιακόΑρχείο' or name() = 'File' ">
                                                    ...
                                                    <xsl:choose>
                                                        <xsl:when test="$mime!=''">
                                                            <td>
                                                                <xsl:choose>
                                                                    ...
                                                                    <xsl:when test="$mime = 'Photos'">
                                                                        <xsl:choose>
                                                                            <xsl:when test=" ./*[1]/text() != '' ">
                                                                                <a href="FetchBinFile?mime={$mime}&amp;type={$photoType}&amp;depository=disk&amp;file={url:encode(./*[1]/text())}"  target="blank_">
                                                                                    <!--Samarita Servlet attempt-->                                                               
                                                                                    <img src="FetchBinFile?mime={$mime}&amp;size=small&amp;type={$photoType}&amp;depository=disk&amp;file={url:encode(./*[1]/text())}" border="1" alt="{$translated}" width="50"></img>
                                                                                </a>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                    ...
                                                                    <xsl:otherwise>
                                                                        <xsl:if test=" ./*[1]/text() != '' ">
                                                                            <a href="FetchBinFile?mime={$mime}&amp;type={$photoType}&amp;depository=disk&amp;file={url:encode(./*[1]/text())}" alt="{$translated}" target="blank_">
                                                                                <xsl:value-of select="$translated"/>
                                                                            </a>
                                                        ...
                                                        <xsl:otherwise>
                                                            <td>
                                                                <a href="FetchBinFile?mime=Photos&amp;type={$photoType}&amp;depository=disk&amp;file={url:encode(./*[1]/text())}" target="blank_">
                                                                    <!--Samarita Servlet attempt-->                                                               
                                                                    <img src="FetchBinFile?mime=Photos&amp;type={$photoType}&amp;size=small&amp;depository=disk&amp;file={url:encode(./*[1]/text())}" border="1" alt="{$translated}" width="50"></img>
                                                                </a>
                                                            </td>
                                                        </xsl:otherwise>
                                                    </xsl:choose>
