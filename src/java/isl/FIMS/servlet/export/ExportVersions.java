    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!hasAccess) {
            ...
            try {
                ...
                for (int i = 0; i < files.length; i++) {
                    ...
                    try {
                        ...
                        if (isWritable.equals("true")) {
                            ...
                            outTemp = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(currentDir + System.getProperty("file.separator") + files[i]), "UTF-8"));
                ...
                f.mkdir();
                String zip = f.getAbsolutePath() + System.getProperty("file.separator") + type + id + ".zip";
