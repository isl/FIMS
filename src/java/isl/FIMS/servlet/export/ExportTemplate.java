...
public class ExportTemplate extends ApplicationBasicServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            File file = new File(currentDir + System.getProperty("file.separator") + type + ".xml");
            ...
            Document doc = ParseXMLFile.parseFile(currentDir + System.getProperty("file.separator") + type + ".xml");
            ...
            ParseXMLFile.saveXMLDocument(currentDir + System.getProperty("file.separator") + type + ".xml", doc);
