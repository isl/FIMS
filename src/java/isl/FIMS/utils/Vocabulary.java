...
public class Vocabulary {
    ...
    public Vocabulary(String vocabulary, String lang, DMSConfig conf) {
        ...
        this.parentName = this.vocFile.query("//name(/*)")[0].toString();
        this.childName = this.vocFile.query("//name(/" + this.parentName + "/*[1])")[0].toString();
    }
    ...
    public String termValueOf(int termId) {
        String[] t = this.vocFile.queryString("//" + this.childName + "[@id='" + termId + "']/text()");
    ...
    /**
     * Returns a list of all terms in this <code>Vocabulary</code>.<br> <br> The
     * returned list contains the whole 'tag' (xml formated), not only the
     * value. <br><br> Example:<br>
     * <b>&lt;"+this.childName+" id="..."&gt;...&lt;/"+this.childName+"&gt;</b>
     *
    ...
    public String[] terms() {
        ...
        String query = "for $b in doc('" + path + "')//" + this.childName + " order by $b/text() collation '?lang=el-gr' return $b ";
        return this.vocFile.queryString(query);
    }

    /**
     * Returns a list of all term values in this <code>Vocabulary</code>.
     *
     * @return a list of all terms in this <code>Vocabulary</code>.
     */
    public String[] termValues() {
        return this.vocFile.queryString("//" + this.childName + "/text()");
    }

    /**
     * Returns a list of all term ids in this <code>Vocabulary</code>.
     *
     * @return a list of all term ids in this <code>Vocabulary</code>.
     */
    public String[] termIds() {
        return this.vocFile.queryString("//" + this.childName + "/@id/string()");
    }

    /**
     * Adds a term to this <code>Vocabulary</code>. The term is assigned with an
    ...
    /**
     * Adds a term with a particular id to this <code>Vocabulary</code>.
     *
    ...
    /**
     * Updates a term (with a particular id) of this <code>Vocabulary</code>.
     *
     * @param id the id of the term to be updated.
     * @param term the (new) value of the term.
     */
    public void updateTerm(int id, String term) {
        String termQ = "//" + this.childName + "[@id='" + id + "']";
        this.vocFile.xUpdate(termQ, term);
    }

    /**
     * Removes a term (with a particular id) from this <code>Vocabulary</code>.
     *
     ...
     * &lt;translation id="..."&gt;
     * <br>&nbsp&nbsp&nbsp&nbsp &lt;gr&gt;value_gr&lt;/gr&gt;
     * <br>&nbsp&nbsp&nbsp&nbsp &lt;en&gt;value_en&lt;/en&gt;
     * <br>&nbsp&nbsp&nbsp&nbsp &lt;fr&gt;value_fr&lt;/fr&gt;
     * <br>&nbsp&nbsp&nbsp&nbsp ...other langs...
     * <br>
     * &lt;/translation&gt;
     * </code></b>
     *
    ...
    public String[] getTermsTranslationVocValues(String[] langs) throws DMSException {
        ...
        q.append("for $i in doc('" + this.transConf.COLLECTION + this.vocName + "')//translation\n");

        for (int i = 0; i < langs.length; i++) {
            String lang = langs[i];
            q.append("let $" + lang + "Id := $i/" + lang + "\n");
            q.append("let $" + lang + " := doc('" + sysVocDbCol + lang + "/" + this.vocName + "')//" + this.childName + "[@id=$" + lang + "Id]/text()\n");
        }
     ...
     * Example:<br> <b><code>
     * &lt;translation id="..."&gt;
     * <br>&nbsp&nbsp&nbsp&nbsp &lt;gr&gt;...&lt;/gr&gt;
     * <br>&nbsp&nbsp&nbsp&nbsp &lt;en&gt;...&lt;/en&gt;
     * <br>&nbsp&nbsp&nbsp&nbsp &lt;fr&gt;...&lt;/fr&gt;
     * <br>&nbsp&nbsp&nbsp&nbsp ...other langs...
     * <br>
     * &lt;/translation&gt;
     * </code></b>
    ...
    /**
     * Returns a term's translation value for this <code>Vocabulary</code>, for
     * a particular translation id and language.
     *
     * @param id the id of the translation.
    ...
    /**
     * Returns the translation languages for this <code>Vocabulary</code>.
     *
    ...
    /**
     * Generates a new term id for this <code>Vocabulary</code>.
     *
     * @return a new id for this <code>Vocabulary</code>.
     */
    public int newId() {
        int newId;
        DBFile[] maxId = this.vocFile.query("max(//" + this.childName + "/@id)");
    ...
    public String getTags() {
        ...
        try {
            ...
            String q = "let $col := string('" + sysDbCol + "') "
                    + "let $b:= (";
            for (String entity : ApplicationBasicServlet.getEntityTypes()) {
                q += "doc(concat($col, 'LaAndLi/" + entity + ".xml')), ";
            }
    ...
    public Hashtable findTermDependantsOf(int termId, String[] types) {
        ...
        for (int i = 0; i < types.length; i++) {
            ...
            for (int f = 0; f < files.length; f++) {
                ...
                String[] dbFs = dbc.query("//*[@sps_vocabulary='" + this.vocName + "' and @sps_id='" + termId + "']");
                if (dbFs.length > 0) {
