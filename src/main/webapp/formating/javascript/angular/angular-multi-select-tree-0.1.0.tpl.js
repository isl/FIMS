angular.module('multi-select-tree').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('src/multi-select-tree.tpl.html',
    ...
    "             </div>\n" +
    "            <div class=\"line\">\n" +
    "                <input placeholder=\"Search...\" type=\"text\" ng-model=\"filterKeyword\" ng-change=\"onkeywordChnage(filterKeyword,inputModel)\" ng-click=\"onFilterClicked($event)\"\n" +
    "                       class=\"input-filter\">\n" +
    "                <span class=\"clear-button\" ng-click=\"clearFilter($event,inputModel)\"><span class=\"item-close\"></span></span>\n" +
    "            </div>\n" +
    "        </div>\n" +
  ...
  $templateCache.put('src/tree-item.tpl.html',
    ...
    "        <tree-item item=\"child\" item-selected=\"subItemSelected(item)\" ng-show=\"!child.isFiltered\"\n" + "use-callback=\"useCallback\"\n" +
