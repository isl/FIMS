                        ...
                        <xsl:otherwise>
                            <xsl:choose>
                                <xsl:when test="$lang='gr'">
                                    ...
                                    <p>
                                        Για οποιαδήποτε διευκρίνιση μπορείτε να επικοινωνήσετε με τον Υπεύθυνο Προστασίας Προσωπικών Δεδομένων του ΙΤΕ στο dpo@admin.forth.gr. </p>
                                ...
                                <xsl:otherwise>
                                    ...
                                    <p>
                                        ...
                                        without use of cookies, but, potentially, to the detriment of its user-friendliness and of the functioning
                                        of certain of its services.
                                        Any personal data collected via cookies that can be correlated to a specific visitor/user shall be
                                        processed exclusively for the purposes cited above.</p>
                                    ...
                                    <p>A page has been created on FACEBOOK for subscription to the newsletter issued by FORTH
                                        (https://www.facebook.com/ITE.HELLAS/app/100265896690345/). For the purpose of disseminating
