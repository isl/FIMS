 ...
 */
public class SessionListener extends ApplicationBasicServlet implements HttpSessionListener, HttpSessionAttributeListener   {
    ...
    public void sessionDestroyed(HttpSessionEvent se) {
        ...
        // inform log file
        String LogMessage = "Session <b>" + session.getId() + "</b> " + DestroyedStr + " on " + currentDate + "session user " + session.getAttribute("username") + "</br>";
       //At logout or session ends set all files locked by the current user to locked no
