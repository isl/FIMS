...
public class TranslateServlet extends ApplicationBasicServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean isAdmin = this.getRights(username).equals("admin");
        ...
        if (this.action.equals("unlocktotranslate")) {
            ...
            boolean userCanRead = xmlE.hasAdminProperty("read", username);
            ...
            if (canTraslate || paging.equals("true")) {
                if (isSaved) {
                    xmlE.setAdminProperty("locked", username);
    ...
    private String createCondition(String lang, String code, String name, String userOrg, String mode, String type, String status, String username) {
