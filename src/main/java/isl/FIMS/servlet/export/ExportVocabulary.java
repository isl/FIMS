...
public class ExportVocabulary extends ApplicationBasicServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            File tempFile = new File(currentDir + System.getProperty("file.separator") + file);
            try {
                BufferedWriter outTemp = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(currentDir + System.getProperty("file.separator") + file), "UTF-8"));
