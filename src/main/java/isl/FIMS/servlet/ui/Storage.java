...
public class Storage extends ApplicationBasicServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("backup")) {
            ...
            backupName = Utils.GenerateBackupFileName(username, this.getTime(), this.getDate(), prefix, this.picSeperator);
...
//                    
        ...
        StringBuffer xml = new StringBuffer(this.xmlStart(menu, username, this.pageTitle, this.lang, "", request));
