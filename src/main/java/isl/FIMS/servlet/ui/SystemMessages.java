    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (feXMLEditor.equals("yes")) {
            ...
            if (link.equals("yes")) {
                ...
                if (editorName != null) {
                    goOnLink = "/" + editorName + "/Index?type=" + EntityType + "&amp;id=" + xmlId + "&amp;category=" + category + "&amp;action=unlockedit&amp;lang=" + this.lang + "&amp;action2=" + action2;
                } else {

                    goOnLink = "/" + this.editorWebapp[0] + "/Index?type=" + EntityType + "&amp;id=" + xmlId + "&amp;category=" + category + "&amp;action=unlockedit&amp;lang=" + this.lang + "&amp;action2=" + action2;
