...
public class Search extends BasicSearchServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String xmlStart = this.xmlStart(this.topmenu, username, "Search", this.lang, "", request);
        ...
        String[] myUsers = DMSUser.getUsersInGroup(this.getUserGroup(username), conf);
        Arrays.sort(myUsers);
        StringBuffer groupsInDB = new StringBuffer();

        groupsInDB.append("<Groups>\n");
        int id = Integer.parseInt(this.getUserGroup(username));
