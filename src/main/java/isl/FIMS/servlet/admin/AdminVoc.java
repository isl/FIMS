        ...
        if (this.action.equals("list_vocs") || this.action.equals("list_vocs_trans")) {
            ...
            if (this.action.equals("list")) {
                ...
                if (!dependants.isEmpty()) {
                    ...
                    xml.append("<tValue>").append(voc.termValueOf(id)).append("</tValue>\n");
                    xml.append("<tId>").append(id).append("</tId>\n");
                ...
                for (int i = 0; i < langs.length; i++) {
                    ...
                    xml.append("<SelectedTerm>").append(voc.getTermTranslationValueOf(id, langs[i])).append("</SelectedTerm>\n");
