    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (this.action.equals("list")) {
            ...
            if (isSysAdmin) {
                ...
                String id = this.getUserGroup(username);
            ...
            if (isAdmin && !id.equals(this.getUserGroup(username))) {
            ...
            if (this.action.equals("insert")) {
                usernameInsert = request.getParameter("username");
                    ...
                    if (this.action.equals("insert")) {
                        if (isAdmin) {
                            ...
                            try {
                                ...
                                group.remove();
                                if (!this.displayMsg.equals("Email_EXIST" + Messages.NL)) {
                        ...
                        if (isAdmin && !ordId.equals(this.getUserGroup(username))) {
                            this.displayMsg = Messages.ACCESS_DENIED;
                        } else {
