        ...
        if (hasAccess) {
            if (action.equals("insertComment")) {
                ...
                if (lastVersionId >= 1) {
                    ...
                    String[] comments = versionDBF.queryString("//admin/versions/comment/text()");
                ...
                xmlE.setAdminProperty("/versionUser", username);
                xmlE.xAppend("//admin/versions", "<comment/>");
                xmlE.xUpdate("//admin/versions/comment", comment);
