 ...
 * @author konsolak
 */
public class UnlockEntity extends ApplicationBasicServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String collName = UtilsQueries.getpath(this.DBURI, this.systemDbCollection + type, this.DBuser, this.DBpassword, type, id);
        DBFile dbF = new DBFile(this.DBURI, collName, type + id + ".xml", this.DBuser, this.DBpassword);
        dbF.queryString(" update value //admin/locked[./text() = '" + username + "']/text() with \"no\" ");

        displayMsg = Messages.ACTION_SUCCESS;
        displayMsg += Messages.NL;
