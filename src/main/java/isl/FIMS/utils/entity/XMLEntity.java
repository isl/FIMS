...
public class XMLEntity extends ApplicationBasicServlet {
    ...
    /**
     * Constructs a new <code>XMLEntity</code> instance associated with an
     * 'Entity' of a particular type. The type of the <code>XMLEntity</code> is
     * determined by the 'type' argument. <br>
     *
     ...
     * Constructs a new <code>XMLEntity</code> instance associated with an
     * 'Entity' of a particular type. The type of the <code>XMLEntity</code> is
     * determined by the 'type' argument. <br> <b>If this constructor is used
     * then functionality involving traslations might NOT work.</b> The reason
     * is that the 'db', 'dbUser' and 'dbPassword' fields are not filled. If
     * they are filled by hand, after the object is constructed, then it is ok.
     *
    ...
    /**
     * Returns <code>true</code> if this <code>XMLEntity</code> is saved or
    ...
    /**
     * Returns <code>true</code> if this <code>XMLEntity</code> is locked or
     * <code>false</code> otherwise.
     *
    ...
    /**
     * Returns the username of the user which this <code>XMLEntity</code> is
     * locked by.
     *
     ...
     * kept inside the file represented by this <code>XMLEntity</code>.
     *
     * @param property the name of the admin property
    ...
    /**
     * Deletes the file associated with the <code>XMLEntity</code> from the
     * database.
     */
    public void delete() {
        this.dbFile.remove();
     ...
     * <code>DBFile</code>. The result is an array (of <code>String</code>)
    ...
    public long xInsertAfter(String selectQuery, String xml) {
        return this.dbFile.xInsertAfter(selectQuery, xml);
    ...
    /**
     * Returns the XML of the <code>XMLEntity</code> as a <code>String</code>.
     *
    ...
    public void translateAllEntities(String fromLang, String toLang, DMSConfig translationConf, ArrayList<DBFile> entitiesForTranslation) throws DMSException {
        ...
        for (DBFile transl : entitiesForTranslation) {
            ...
            String docOrg = transl.queryString("//admin/organization/text()")[0];
            ...
            for (int i = 0; i < texts.length; i++) {
                ...
                if (!xmlEnt.getDbFile().queryString("//admin/lang/text()")[0].equals(toLang)) {
    ...
    /**
     * Returns a <code>DBFile</code> associated with the 'Entity' with which
